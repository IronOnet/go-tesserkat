...
// nonZeroCheck returns the expression that checks whether 'v' is a non-zero value of 
// type 'vtyp' 
...
// isBigInt check whether 'typ' is "math/big" .Int 
...
// isByte checks whetther the underlying type of 'typ' is uint8 
